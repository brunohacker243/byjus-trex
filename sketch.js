...
function setup() {
  ...
  trex = createSprite(50,0-height+1100,20,50);
  ...
  gameOver = createSprite(width/2,height/2-50,400,20);
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //deixar o solo rapido
    ground.velocityX = ground.velocityX * 1.5;
  ...
  if (score % 1000 === 0 && score > 0 || score % 2000 === 0 && score > 0) {
